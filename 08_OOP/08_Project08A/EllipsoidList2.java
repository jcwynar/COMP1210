...
public class EllipsoidList2 {
   ...
   //*********************************************
   //********** Begin new NEW methods ************
   //*********************************************                          
   
   /**
    * Method to find ellipsoid with smallest volume.
    *
    * @return null, e1
    */
   public Ellipsoid findEllipsoidWithSmallestVolume()   {
      ...
      Ellipsoid e1 = eList[0];
      for (int i = 0; i < eList.length; i++)   {
         Ellipsoid e2 = eList[i];
   ...
   /**
    * Method to find ellipsoid with largest volume.
    *
    * @return null, e1
    */
   public Ellipsoid findEllipsoidWithLargestVolume()   {
    ...
    /**
     * Method to find ellipsoid with smallest surface area.
     *
     * @return null, e3
     */
   public Ellipsoid findEllipsoidWithSmallestSurfaceArea()   {
      ...
      Ellipsoid e3 = eList[0];
      for (int i = 0; i < eList.length; i++)   {
         Ellipsoid e4 = eList[i];
         if (e3.surfaceArea() > e4.surfaceArea())   {
            e3 = e4;
         }
      }
      return e3;
    ...
    /**
     * Method to find ellipsoid with largest surface area.
     *
     * @return null, e3
     */
