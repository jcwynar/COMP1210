...
public class EllipsoidTest {
   ...
   @Test public void gettersTest() {
      ...
      Assert.assertEquals("getLabel test", "Ex 1", e.getLabel());
      
      Assert.assertEquals("getA test", 1.0, e.getA(), .000001);
      
      Assert.assertEquals("getB test", 2.0, e.getB(), .000001);
      
      Assert.assertEquals("getC test", 3.0, e.getC(), .000001);
   }
